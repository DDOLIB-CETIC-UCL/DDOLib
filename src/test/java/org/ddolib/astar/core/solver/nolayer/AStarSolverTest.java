...
public class AStarSolverTest {
    ...
    public void testTSPAStarSolver() {
        ...
        org.ddolib.modeling.Model<org.ddolib.examples.layered.tsp.TSPState> layeredModel = new org.ddolib.modeling.Model<>() {
            @Override
            public org.ddolib.modeling.Problem<org.ddolib.examples.layered.tsp.TSPState> problem() {
                return layeredProblem;
            }
            @Override
            public org.ddolib.modeling.FastLowerBound<org.ddolib.examples.layered.tsp.TSPState> lowerBound() {
                return new org.ddolib.examples.layered.tsp.TSPFastLowerBound(layeredProblem);
            }
        };
        org.ddolib.astar.core.solver.layered.AStarSolver<org.ddolib.examples.layered.tsp.TSPState> layeredSolver = new org.ddolib.astar.core.solver.layered.AStarSolver<>(layeredModel);
        ...
        NoLayerModel<TSPState> noLayerModel = new TSPModel(noLayerProblem);
