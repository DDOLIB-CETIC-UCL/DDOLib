    ...
    Stream<DynamicTest> testMisp() {
        ...
        NoLayerNonRegressionTestBench<MispState, MispProblem> testBench = new NoLayerNonRegressionTestBench<>(testDataSupplier) {
            ...
            protected void testAllSolver(MispProblem problem) {
                ...
                org.ddolib.nolayer.modeling.DdoModel<MispState> globalModel = testDataSupplier.model(problem);
                
                boolean dominanceUsed = true; // We use dominance

                // DDO tests
                org.ddolib.nolayer.modeling.DdoModel<MispState> ddoModelNoDom = wrapDdoModel(globalModel, false, false, null);
                ...
                // ACS tests
                org.ddolib.nolayer.modeling.AcsModel<MispState> acsModelNoDom = wrapAcsModel(globalModel, false, null);
                double acsVal = solveAndChecksSolution(acsModelNoDom, "ACS");
                
                org.ddolib.nolayer.modeling.AcsModel<MispState> acsModel = wrapAcsModel(globalModel, true, null);
