...
public class Solvers {
    ...
    public static <T, K> SequentialSolver<T, K> sequentialSolver(final Problem<T> problem,
                                                                 ...
                                                                 final int seed) {
        return new SequentialSolver<>(problem, relax, varh, ranking, width, frontier, fub, dominance, relaxStrat, restrictionStrat, distance, coord, seed);
    }
    ...
    public static <T> SequentialSolver<T, Integer> sequentialSolver(final Problem<T> problem,
        ...
        return new SequentialSolver<>(problem, relax, varh, ranking, width, frontier, fub, defaultDominance, relaxStrat, restrictionStrat, distance, coord, seed);
    }
    ...
    public static <T, K> SequentialSolver<T, K> sequentialSolver(final Problem<T> problem,
        ...
        return new SequentialSolver<>(problem, relax, varh, ranking, width, frontier, defaultFub, dominance, relaxStrat, restrictionStrat, distance, coord, seed);
    }
    ...
    public static <T> SequentialSolver<T, Integer> sequentialSolver(final Problem<T> problem,
        ...
        DefaultFastUpperBound<T> defaultFub = new DefaultFastUpperBound<>();
        DefaultDominanceChecker<T> defaultDominance = new DefaultDominanceChecker<>();
        return new SequentialSolver<>(problem, relax, varh, ranking, width, frontier,defaultFub, defaultDominance, relaxStrat, restrictionStrat, distance, coord, seed);
    }
