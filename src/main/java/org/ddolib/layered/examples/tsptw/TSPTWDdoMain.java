...
/**
 * The Traveling Salesman Problem with Time Windows (TSP with Time Windows) with
 * Ddo.
 * Main class for solving the Traveling Salesman Problem with Time Windows
 * (TSPTW)
 * using a Decision Diagram Optimization (DDO) approach.
 * <p>
 * This class demonstrates how to load a TSPTW problem instance, define a DDO
 * model with relaxation, ranking,
 * lower bound, dominance, frontier, width heuristic, and caching, and solve the
 * problem using
 ...
 * <a href="https://lopez-ibanez.eu/tsptw-instances#makespan">López-Ibáñes and
 * Blum benchmark instances</a>.
 * </p>
 */
public class TSPTWDdoMain {
     ...
     * </p>
     * <ol>
     * <li>Loads the TSPTW problem instance from a file (default or provided via
     * arguments).</li>
     ...
     * <li>Dominance using {@link TSPTWDominance} and
     * {@link SimpleDominanceChecker}</li>
     * <li>Frontier using {@link SimpleFrontier} and
     * {@link CutSetType#Frontier}</li>
     ...
     * </ol>
     *
     * @param args optional command-line arguments specifying the instance file and
     *             maximum width
     * @throws IOException if an I/O error occurs while reading the instance file or
