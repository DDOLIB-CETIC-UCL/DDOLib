 ...
 * a profit value values_i, a weight weights_i and a quantity quantity_i of identical copies of this item.
 * The goal is to select quantities of each item i, such that the total weight of the selected items does not
 * exceed the knapsack capacity and the total profit is maximized.
 */
package org.ddolib.layered.examples.boundedknapsack;