 ...
 *                      modeled by {@link RoutingNode}. Therefore, in the merged states, vehicle can be "at any position
 *                      at the same time", modeled by {@link VirtualRoutingNodes}.
 ...
 */
public record TSPTWState(RoutePosition position, int time, BitSet mustVisit, BitSet possiblyVisit, int depth) {
