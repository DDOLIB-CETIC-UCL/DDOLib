...
/**
 * This strategy uses Generalized Hyperplan partitioning to create the clusters, but use a different priority function
 * to determine which cluster should be cut in half to create new clusters
