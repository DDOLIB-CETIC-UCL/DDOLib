...
//        final SimpleDominanceChecker<JSState, BitSet> dominance = new SimpleDominanceChecker<>(new JSDominance(problem),
//                problem.nbVars());
//        final SimpleDominanceChecker<JSState, BitSet> dominanceLNS = new SimpleDominanceChecker<>(new JSDominance(problem),
//                problem.nbVars());
//
//
//        ArrayList<Precedence> preds = new ArrayList<>();
...
//
//        final LNSSolver lnsSolver = new LNSSolver(problemLNS,varh,fubLNS,dominanceLNS,10);
//
//        final Solver solverACSwLNS = acswLNSSolver(
//                problem,
//                varh,
//                fub,
//                dominance,
