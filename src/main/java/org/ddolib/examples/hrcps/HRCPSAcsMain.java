...
/**
 * Solves the HRCPS problem (minimise number of stations) using Anytime Column Search.
 */
public class HRCPSAcsMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("HRCPS – Minimise Stations (ACS Solver)");
        System.out.println("=".repeat(80));
        ...
        final AcsModel<HRCPSState> model = new AcsModel<>() {
        ...
        Solution solution = Solvers.minimizeAcs(model, (sol, stats) -> {
            System.out.println("\n===== New Incumbent =====");
