...
public class MispMeasureRelaxation {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final Set<Integer> varSet = new HashSet<>(problem.nbVars());
        for (int i = 0; i < problem.nbVars(); i++) {
            varSet.add(i);
        }
        final double fastLB = fub.fastUpperBound(problem.initialState(), varSet);
