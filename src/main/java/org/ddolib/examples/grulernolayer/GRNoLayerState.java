...
public class GRNoLayerState {
    ...
    /**
     * Constructs a new {@link GRNoLayerState} from given sets of marks and distances.
     * <p>
     ...
     */
    public GRNoLayerState(BitSet marks, BitSet distances, int lastMark) {
     ...
     *
     * @return a new {@link GRNoLayerState} identical to the current one.
     */
    public GRNoLayerState copy() {
        return new GRNoLayerState(marks, distances, lastMark);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof GRNoLayerState other) {
